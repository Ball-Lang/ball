...
| Metric | Count |
|---|---|
| Total base functions | 306 |
| Encoder-emittable | 145 |
| Covered by a conformance fixture | 168 |
| Dart engine-implemented | 268 |
...
|---|---|---|---|
| `add` | ✅ | ✅ 110 fixture(s): `101_simple_class`, `104_getter_setter`, `107_method_override_super` +107 more | ✅ |
...
| `assign` | ✅ | ✅ 131 fixture(s): `100_complex_control_flow`, `101_simple_class`, `104_getter_setter` +128 more | ✅ |
...
| `cascade` | ❌ | ❌ | ✅ |
| `ceil_to_double` | ✅ | ✅ 1 fixture(s): `351_num_to_double` | ✅ |
...
| `concat` | ✅ | ✅ 104 fixture(s): `101_simple_class`, `102_inheritance`, `103_abstract_class` +101 more | ✅ |
...
| `equals` | ✅ | ✅ 73 fixture(s): `100_complex_control_flow`, `113_operator_overloading`, `117_list_generate` +70 more | ✅ |
| `floor_to_double` | ✅ | ✅ 1 fixture(s): `351_num_to_double` | ✅ |
...
| `if` | ✅ | ✅ 89 fixture(s): `100_complex_control_flow`, `105_static_methods`, `106_factory_constructor` +86 more | ✅ |
| `index` | ✅ | ✅ 59 fixture(s): `106_factory_constructor`, `119_nested_maps`, `120_list_of_maps` +56 more | ✅ |
| `int_to_double` | ❌ | ❌ | ✅ |
| `int_to_string` | ✅ | ✅ 1 fixture(s): `389_typed_to_string` | ✅ |
| `invoke` | ✅ | ✅ 6 fixture(s): `203_closure_in_loop`, `223_closure_loop_capture`, `224_currying_partial_apply` +3 more | ✅ |
...
| `labeled` | ✅ | ✅ 3 fixture(s): `148_labeled_loops`, `23_labeled_break`, `280_enc_labeled_break` | ✅ |
| `left_shift` | ✅ | ✅ 4 fixture(s): `206_integer_arithmetic_edge`, `251_bitwise_signed_edges`, `284_enc_bitwise` +1 more | ✅ |
| `length` | ❌ | ❌ | ✅ |
| `less_than` | ✅ | ✅ 76 fixture(s): `100_complex_control_flow`, `105_static_methods`, `127_zip_lists` +73 more | ✅ |
| `list_filled` | ❌ | ✅ 1 fixture(s): `197_memory_limit` | ✅ |
| `list_generate` | ❌ | ❌ | ✅ |
| `lte` | ✅ | ✅ 42 fixture(s): `105_static_methods`, `125_group_by`, `132_merge_sort` +39 more | ✅ |
| `map_create` | ✅ | ✅ 33 fixture(s): `106_factory_constructor`, `116_map_iteration`, `119_nested_maps` +30 more | ✅ |
...
| `math_clamp` | ✅ | ✅ 2 fixture(s): `259_math_functions`, `416_user_method_name_arity_collision` | ✅ |
| `math_cos` | ❌ | ❌ | ✅ |
| `math_e` | ❌ | ❌ | ✅ |
| `math_exp` | ❌ | ❌ | ✅ |
...
| `math_infinity` | ❌ | ❌ | ✅ |
| `math_is_finite` | ✅ | ✅ 3 fixture(s): `215_infinity_arithmetic`, `317_primitive_number_getters`, `476_user_member_named_like_builtin_accessor` | ✅ |
| `math_is_infinite` | ✅ | ✅ 4 fixture(s): `215_infinity_arithmetic`, `263_numeric_properties`, `317_primitive_number_getters` +1 more | ✅ |
| `math_is_nan` | ✅ | ✅ 5 fixture(s): `214_nan_propagation`, `215_infinity_arithmetic`, `263_numeric_properties` +2 more | ✅ |
| `math_lcm` | ❌ | ❌ | ✅ |
| `math_log` | ❌ | ❌ | ✅ |
| `math_log10` | ❌ | ❌ | ✅ |
| `math_log2` | ❌ | ❌ | ✅ |
...
| `math_sign` | ✅ | ✅ 3 fixture(s): `262_getter_properties`, `317_primitive_number_getters`, `476_user_member_named_like_builtin_accessor` | ✅ |
| `math_sin` | ❌ | ❌ | ✅ |
| `math_sqrt` | ❌ | ❌ | ✅ |
| `math_tan` | ❌ | ❌ | ✅ |
| `math_trunc` | ✅ | ✅ 2 fixture(s): `259_math_functions`, `320_num_methods_on_double_local` | ✅ |
| `modulo` | ✅ | ✅ 37 fixture(s): `108_class_tostring`, `117_list_generate`, `125_group_by` +34 more | ✅ |
| `multiply` | ✅ | ✅ 68 fixture(s): `100_complex_control_flow`, `101_simple_class`, `103_abstract_class` +65 more | ✅ |
| `negate` | ✅ | ✅ 45 fixture(s): `105_static_methods`, `135_linear_search_sentinel`, `170_pattern_switch_expr` +42 more | ✅ |
| `not` | ✅ | ✅ 5 fixture(s): `125_group_by`, `129_unique_elements`, `256_editions_resolver` +2 more | ✅ |
| `not_equals` | ✅ | ✅ 16 fixture(s): `108_class_tostring`, `135_linear_search_sentinel`, `136_string_pattern_match` +13 more | ✅ |
| `null_aware_access` | ❌ | ❌ | ✅ |
| `null_aware_call` | ❌ | ❌ | ✅ |
| `null_aware_cascade` | ❌ | ❌ | ✅ |
...
| `print` | ✅ | ✅ 364 fixture(s): `100_complex_control_flow`, `101_simple_class`, `102_inheritance` +361 more | ✅ |
...
| `return` | ✅ | ✅ 60 fixture(s): `105_static_methods`, `106_factory_constructor`, `109_enum_values` +57 more | ✅ |
| `right_shift` | ✅ | ✅ 5 fixture(s): `206_integer_arithmetic_edge`, `251_bitwise_signed_edges`, `284_enc_bitwise` +2 more | ✅ |
| `round_to_double` | ✅ | ✅ 1 fixture(s): `351_num_to_double` | ✅ |
...
| `spread` | ✅ | ✅ 2 fixture(s): `309_spread_elements`, `310_set_map_comprehension` | ✅ |
| `string_char_at` | ❌ | ❌ | ✅ |
| `string_char_code_at` | ❌ | ❌ | ✅ |
...
| `string_is_empty` | ✅ | ✅ 13 fixture(s): `115_generic_class`, `123_queue_simulation`, `213_string_edge_cases` +10 more | ✅ |
| `string_is_not_empty` | ✅ | ✅ 11 fixture(s): `123_queue_simulation`, `195_deep_nesting`, `199_malicious_input_patterns` +8 more | ✅ |
...
| `to_string` | ✅ | ✅ 196 fixture(s): `101_simple_class`, `102_inheritance`, `103_abstract_class` +193 more | ✅ |
...
| `typed_list` | ✅ | ✅ 16 fixture(s): `203_closure_in_loop`, `205_map_ordering`, `209_generator_filtered_state` +13 more | ✅ |
...
| `yield_each` | ✅ | ✅ 1 fixture(s): `174_generator_yield_star` | ✅ |
...
| `list_find` | ❌ | ✅ 2 fixture(s): `463_list_find_no_match`, `465_state_error_message` | ✅ |
| `list_first` | ❌ | ✅ 1 fixture(s): `465_state_error_message` | ✅ |
| `list_flat_map` | ❌ | ❌ | ✅ |
...
| `list_push` | ✅ | ✅ 34 fixture(s): `111_cascade_operator`, `115_generic_class`, `120_list_of_maps` +31 more | ✅ |
| `list_reduce` | ✅ | ✅ 1 fixture(s): `318_list_reduce` | ✅ |
| `list_remove_at` | ✅ | ✅ 1 fixture(s): `123_queue_simulation` | ✅ |
| `list_reverse` | ✅ | ✅ 2 fixture(s): `387_list_reverse_getter`, `476_user_member_named_like_builtin_accessor` | ✅ |
| `list_set` | ❌ | ❌ | ✅ |
| `list_single` | ❌ | ❌ | ✅ |
...
| `list_sort_by` | ❌ | ❌ | ✅ |
| `list_take` | ❌ | ❌ | ✅ |
| `list_to_list` | ✅ | ✅ 13 fixture(s): `118_set_operations`, `124_frequency_counter`, `125_group_by` +10 more | ✅ |
| `list_zip` | ❌ | ❌ | ✅ |
| `map_contains_key` | ✅ | ✅ 11 fixture(s): `106_factory_constructor`, `125_group_by`, `153_memoized_recursive` +8 more | ✅ |
| `map_contains_value` | ✅ | ✅ 1 fixture(s): `468_map_contains_value` | ✅ |
| `map_delete` | ❌ | ❌ | ✅ |
| `map_entries` | ❌ | ❌ | ✅ |
| `map_filter` | ❌ | ❌ | ✅ |
| `map_from_entries` | ❌ | ❌ | ✅ |
...
| `map_map` | ❌ | ❌ | ✅ |
| `map_merge` | ❌ | ❌ | ✅ |
| `map_put_if_absent` | ✅ | ✅ 1 fixture(s): `469_map_put_if_absent` | ✅ |
| `map_set` | ❌ | ❌ | ✅ |
| `map_values` | ❌ | ❌ | ✅ |
...
| Function | Encoder-emittable | Covered by fixture | Dart engine |
|---|---|---|---|
| `atomic_compare_exchange` | ❌ | ✅ 1 fixture(s): `477_std_concurrency_handles` | ✅ |
| `atomic_create` | ❌ | ✅ 1 fixture(s): `477_std_concurrency_handles` | ✅ |
| `atomic_load` | ❌ | ✅ 1 fixture(s): `477_std_concurrency_handles` | ✅ |
| `atomic_store` | ❌ | ✅ 1 fixture(s): `477_std_concurrency_handles` | ✅ |
| `mutex_create` | ❌ | ✅ 1 fixture(s): `477_std_concurrency_handles` | ✅ |
| `mutex_lock` | ❌ | ✅ 1 fixture(s): `477_std_concurrency_handles` | ✅ |
| `mutex_unlock` | ❌ | ✅ 1 fixture(s): `477_std_concurrency_handles` | ✅ |
| `scoped_lock` | ❌ | ✅ 1 fixture(s): `477_std_concurrency_handles` | ✅ |
| `thread_join` | ❌ | ✅ 1 fixture(s): `477_std_concurrency_handles` | ✅ |
| `thread_spawn` | ❌ | ✅ 1 fixture(s): `477_std_concurrency_handles` | ✅ |

## Gaps

### Not encoder-emittable (161) — no Dart-source construct routes to this function
...
- `std.cascade`
- `std.dart_list_filled`
- `std.dart_list_generate`
- `std_time.day`
- `std_memory.deref`
- `std_fs.dir_create`
- `std_fs.dir_exists`
...
- `std_time.now`
- `std_time.now_micros`
- `std.null_aware_access`
- `std.null_aware_call`
- `std.null_aware_cascade`
- `std_memory.nullptr`
- `std_io.panic`
