...
int main() {
    ...
    std::cout << ball_to_string(ball_to_string(abs_(3LL))) << std::endl;
    std::cout << ball_to_string(ball_to_string(max_(10LL, 20LL))) << std::endl;
    std::cout << ball_to_string(ball_to_string(min_(10LL, 20LL))) << std::endl;
    return 0;
}
