...
int main() {
    auto add5 = BallDyn(adder(5LL));
    auto add10 = BallDyn(adder(10LL));
    std::cout << ball_to_string(ball_to_string(add5(3LL))) << std::endl;
    std::cout << ball_to_string(ball_to_string(add10(3LL))) << std::endl;
    std::cout << ball_to_string(ball_to_string(add5(add10(1LL)))) << std::endl;
    return 0;
}
