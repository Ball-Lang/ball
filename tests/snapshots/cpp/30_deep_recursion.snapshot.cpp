...
int main() {
    std::cout << ball_to_string(ball_to_string(sumTo(10LL))) << std::endl;
    std::cout << ball_to_string(ball_to_string(sumTo(100LL))) << std::endl;
    std::cout << ball_to_string(ball_to_string(power(2LL, 10LL))) << std::endl;
    std::cout << ball_to_string(ball_to_string(power(3LL, 4LL))) << std::endl;
    return 0;
}
