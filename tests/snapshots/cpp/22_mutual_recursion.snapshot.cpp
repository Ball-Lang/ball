...
int main() {
    std::cout << ball_to_string(ball_to_string(isEven(0LL))) << std::endl;
    std::cout << ball_to_string(ball_to_string(isOdd(7LL))) << std::endl;
    std::cout << ball_to_string(ball_to_string(isEven(10LL))) << std::endl;
    std::cout << ball_to_string(ball_to_string(isOdd(10LL))) << std::endl;
    return 0;
}
