...
int main() {
    ...
    std::cout << ("hello, "s + ball_to_string(name)) << std::endl;
    std::cout << ball_to_string(static_cast<int64_t>(name.size())) << std::endl;
    std::cout << [](std::string s){std::transform(s.begin(),s.end(),s.begin(),::toupper);return s;}(name) << std::endl;
    return 0;
}
