...
# ball_protobuf_rt.h is GENERATED ("Generated by ball compiler (C++ target,
# library mode)" — the compiled ball_protobuf Ball module), same class as
# engine_rt.cpp / gen/: excluded from the hand-written measurement. It entered
# the instrumented set with #18 Stage 5 (ball_rt_decode.cpp now always
# compiles it), and its ~3.7k machine-emitted lines at ~16% dragged the shared
# bucket from ~81% to ~42% overnight — measuring generated output tells us
# nothing about hand-written test quality (its behavior is pinned by the
# ball_rt_decode/ball_file tests that drive it and by ball_protobuf's own
# Dart-side conformance).
# (ball_program_descriptor.h is generated too — "GENERATED by
# dart/ball_protobuf/tool/gen_program_descriptor_cpp.dart / DO NOT EDIT".)
lcov --remove "$MERGED" \
  '/usr/*' '*/_deps/*' '*/build-cov/*' '*/gen/*' '*/test/*' \
  '*/dart/self_host/lib/engine_rt.cpp' \
  '*/cpp/shared/ball_protobuf_rt.h' \
  '*/cpp/shared/ball_program_descriptor.h' \
