...
| `print` | ✅ | ✅ 345 fixture(s): `100_complex_control_flow`, `101_simple_class`, `102_inheritance` +342 more | ✅ |
| `regex_find` | ❌ | ❌ | ✅ |
| `regex_find_all` | ❌ | ❌ | ✅ |
| `regex_match` | ❌ | ❌ | ✅ |
| `regex_replace` | ❌ | ❌ | ✅ |
...
| `to_string` | ✅ | ✅ 187 fixture(s): `101_simple_class`, `102_inheritance`, `103_abstract_class` +184 more | ✅ |
