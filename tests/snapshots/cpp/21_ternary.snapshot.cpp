...
BallDyn abs_(int64_t x) {
    auto& input = x;
    return (BallDyn((x < 0LL) ? BallDyn((-x)) : BallDyn(x)));
    return BallDyn();
}

BallDyn sign(int64_t x) {
    auto& input = x;
    return (BallDyn((x > 0LL) ? BallDyn("pos"s) : BallDyn(((BallDyn((x < 0LL) ? BallDyn("neg"s) : BallDyn("zero"s)))))));
    return BallDyn();
}
...
int main() {
    std::cout << ball_to_string(ball_to_string(abs_((-5LL)))) << std::endl;
    std::cout << ball_to_string(ball_to_string(abs_(7LL))) << std::endl;
    std::cout << ball_to_string(sign(3LL)) << std::endl;
    std::cout << ball_to_string(sign((-3LL))) << std::endl;
    std::cout << ball_to_string(sign(0LL)) << std::endl;
    return 0;
}
