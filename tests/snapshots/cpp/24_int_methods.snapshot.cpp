...
int main() {
    ...
    std::cout << ball_to_string(ball_to_string([](BallDyn _v) -> BallDyn { if(_v.type()==typeid(int64_t))return BallDyn(std::abs(static_cast<int64_t>(_v))); return BallDyn(std::abs(static_cast<double>(_v))); }((-n)))) << std::endl;
    std::cout << ball_to_string(ball_to_string([&](int64_t _a, int64_t _b){ auto _r = _a % _b; return _r < 0 ? _r + (_b < 0 ? -_b : _b) : _r; }(static_cast<int64_t>(7LL), static_cast<int64_t>(3LL)))) << std::endl;
    std::cout << ball_to_string(ball_to_string((7LL / 3LL))) << std::endl;
    return 0;
}
