...
namespace ball {
inline constexpr const char* BALL_EMIT_RUNTIME_SOURCE =
R"BALL_RT(// ball_emit_runtime.h — single source of truth for the small runtime
...
R"BALL_RT(if (m.count("listValue") && m.at("listValue").has_value()) return "listValue";
    }
    return "notSet";
}
...
// ── Function type stub ──
// Dart code references `Function` as a type.)BALL_RT"
R"BALL_RT( In C++ it doesn't exist
