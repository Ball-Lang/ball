...
Module buildStdCollectionsModule() {
  ...
  module.functions.addAll([
    ...
    _fn('list_reverse', 'ListInput', '', 'Reverse: list.reversed.toList()'),
    _fn('list_slice', 'ListSliceInput', '', 'Slice: list.sublist(start, end)'),
    _fn(
      'list_flat_map',
      'ListCallbackInput',
      '',
    ...
    _fn('set_union', 'SetBinaryInput', '', 'Union: left.union(right)'),
    _fn(
      'set_intersection',
      'SetBinaryInput',
      '',
