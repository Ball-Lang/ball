...
int main() {
    std::cout << ball_to_string(ball_to_string(pipeline(2LL))) << std::endl;
    std::cout << ball_to_string(ball_to_string(pipeline(0LL))) << std::endl;
    std::cout << ball_to_string(ball_to_string(triple(triple(triple(1LL))))) << std::endl;
    return 0;
}
