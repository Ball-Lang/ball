...
int main() {
    std::cout << ball_to_string(ball_to_string(firstPositive((-1LL), 5LL, 2LL))) << std::endl;
    std::cout << ball_to_string(ball_to_string(firstPositive((-1LL), (-2LL), 7LL))) << std::endl;
    std::cout << ball_to_string(ball_to_string(firstPositive((-1LL), (-2LL), (-3LL)))) << std::endl;
    return 0;
}
