...
class Pattern extends $pb.GeneratedMessage {
  factory Pattern({
    ...
    if (typeTest != null) result.typeTest = typeTest;
    if (destructure != null) result.destructure = destructure;
    if (list != null) result.list = list;
    if (map != null) result.map = map;
    if (or != null) result.or = or;
    if (and != null) result.and = and;
    if (relational != null) result.relational = relational;
    if (binding != null) result.binding = binding;
    if (rest != null) result.rest = rest;
    if (guard != null) result.guard = guard;
    if (metadata != null) result.metadata = metadata;
    return result;
  }
  ...
  static const $core.Map<$core.int, Pattern_Kind> _Pattern_KindByTag = {
    1: Pattern_Kind.wildcard,
    2: Pattern_Kind.variable,
    3: Pattern_Kind.constant,
    4: Pattern_Kind.typeTest,
    5: Pattern_Kind.destructure,
    6: Pattern_Kind.list,
    7: Pattern_Kind.map,
    8: Pattern_Kind.or,
    9: Pattern_Kind.and,
    10: Pattern_Kind.relational,
    11: Pattern_Kind.binding,
    12: Pattern_Kind.rest,
    0: Pattern_Kind.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<WildcardPattern>(1, _omitFieldNames ? '' : 'wildcard',
        subBuilder: WildcardPattern.create)
    ..aOM<VariablePattern>(2, _omitFieldNames ? '' : 'variable',
        subBuilder: VariablePattern.create)
    ..aOM<ConstantPattern>(3, _omitFieldNames ? '' : 'constant',
        subBuilder: ConstantPattern.create)
    ..aOM<TypeTestPattern>(4, _omitFieldNames ? '' : 'typeTest',
        subBuilder: TypeTestPattern.create)
    ..aOM<DestructurePattern>(5, _omitFieldNames ? '' : 'destructure',
        subBuilder: DestructurePattern.create)
    ..aOM<ListPattern>(6, _omitFieldNames ? '' : 'list',
        subBuilder: ListPattern.create)
    ..aOM<MapPattern>(7, _omitFieldNames ? '' : 'map',
        subBuilder: MapPattern.create)
    ..aOM<OrPattern>(8, _omitFieldNames ? '' : 'or',
        subBuilder: OrPattern.create)
    ..aOM<AndPattern>(9, _omitFieldNames ? '' : 'and',
        subBuilder: AndPattern.create)
    ..aOM<RelationalPattern>(10, _omitFieldNames ? '' : 'relational',
        subBuilder: RelationalPattern.create)
    ..aOM<BindingPattern>(11, _omitFieldNames ? '' : 'binding',
        subBuilder: BindingPattern.create)
    ..aOM<RestPattern>(12, _omitFieldNames ? '' : 'rest',
        subBuilder: RestPattern.create)
    ..aOM<Expression>(15, _omitFieldNames ? '' : 'guard',
        subBuilder: Expression.create)
    ..aOM<$0.Struct>(16, _omitFieldNames ? '' : 'metadata',
        subBuilder: $0.Struct.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(11)
  @$pb.TagNumber(12)
  Pattern_Kind whichKind() => _Pattern_KindByTag[$_whichOneof(0)]!;
  @$pb.TagNumber(1)
  @$pb.TagNumber(2)
  @$pb.TagNumber(3)
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(1)
  WildcardPattern get wildcard => $_getN(0);
  @$pb.TagNumber(1)
  set wildcard(WildcardPattern value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasWildcard() => $_has(0);
  @$pb.TagNumber(1)
  void clearWildcard() => $_clearField(1);
  @$pb.TagNumber(1)
  WildcardPattern ensureWildcard() => $_ensure(0);

  @$pb.TagNumber(2)
  VariablePattern get variable => $_getN(1);
  @$pb.TagNumber(2)
  set variable(VariablePattern value) => $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasVariable() => $_has(1);
  @$pb.TagNumber(2)
  void clearVariable() => $_clearField(2);
  @$pb.TagNumber(2)
  VariablePattern ensureVariable() => $_ensure(1);

  @$pb.TagNumber(3)
  ConstantPattern get constant => $_getN(2);
  @$pb.TagNumber(3)
  set constant(ConstantPattern value) => $_setField(3, value);
  @$pb.TagNumber(3)
  $core.bool hasConstant() => $_has(2);
  @$pb.TagNumber(3)
  void clearConstant() => $_clearField(3);
  @$pb.TagNumber(3)
  ConstantPattern ensureConstant() => $_ensure(2);

  @$pb.TagNumber(4)
  TypeTestPattern get typeTest => $_getN(3);
  @$pb.TagNumber(4)
  set typeTest(TypeTestPattern value) => $_setField(4, value);
  @$pb.TagNumber(4)
  $core.bool hasTypeTest() => $_has(3);
  @$pb.TagNumber(4)
  void clearTypeTest() => $_clearField(4);
  @$pb.TagNumber(4)
  TypeTestPattern ensureTypeTest() => $_ensure(3);

  @$pb.TagNumber(5)
  DestructurePattern get destructure => $_getN(4);
  @$pb.TagNumber(5)
  set destructure(DestructurePattern value) => $_setField(5, value);
  @$pb.TagNumber(5)
  $core.bool hasDestructure() => $_has(4);
  @$pb.TagNumber(5)
  void clearDestructure() => $_clearField(5);
  @$pb.TagNumber(5)
  DestructurePattern ensureDestructure() => $_ensure(4);

  @$pb.TagNumber(6)
  ListPattern get list => $_getN(5);
  @$pb.TagNumber(6)
  set list(ListPattern value) => $_setField(6, value);
  @$pb.TagNumber(6)
  $core.bool hasList() => $_has(5);
  @$pb.TagNumber(6)
  void clearList() => $_clearField(6);
  @$pb.TagNumber(6)
  ListPattern ensureList() => $_ensure(5);

  @$pb.TagNumber(7)
  MapPattern get map => $_getN(6);
  @$pb.TagNumber(7)
  set map(MapPattern value) => $_setField(7, value);
  @$pb.TagNumber(7)
  $core.bool hasMap() => $_has(6);
  @$pb.TagNumber(7)
  void clearMap() => $_clearField(7);
  @$pb.TagNumber(7)
  MapPattern ensureMap() => $_ensure(6);

  @$pb.TagNumber(8)
  OrPattern get or => $_getN(7);
  @$pb.TagNumber(8)
  set or(OrPattern value) => $_setField(8, value);
  @$pb.TagNumber(8)
  $core.bool hasOr() => $_has(7);
  @$pb.TagNumber(8)
  void clearOr() => $_clearField(8);
  @$pb.TagNumber(8)
  OrPattern ensureOr() => $_ensure(7);

  @$pb.TagNumber(9)
  AndPattern get and => $_getN(8);
  @$pb.TagNumber(9)
  set and(AndPattern value) => $_setField(9, value);
  @$pb.TagNumber(9)
  $core.bool hasAnd() => $_has(8);
  @$pb.TagNumber(9)
  void clearAnd() => $_clearField(9);
  @$pb.TagNumber(9)
  AndPattern ensureAnd() => $_ensure(8);

  @$pb.TagNumber(10)
  RelationalPattern get relational => $_getN(9);
  @$pb.TagNumber(10)
  set relational(RelationalPattern value) => $_setField(10, value);
  @$pb.TagNumber(10)
  $core.bool hasRelational() => $_has(9);
  @$pb.TagNumber(10)
  void clearRelational() => $_clearField(10);
  @$pb.TagNumber(10)
  RelationalPattern ensureRelational() => $_ensure(9);

  @$pb.TagNumber(11)
  BindingPattern get binding => $_getN(10);
  @$pb.TagNumber(11)
  set binding(BindingPattern value) => $_setField(11, value);
  @$pb.TagNumber(11)
  $core.bool hasBinding() => $_has(10);
  @$pb.TagNumber(11)
  void clearBinding() => $_clearField(11);
  @$pb.TagNumber(11)
  BindingPattern ensureBinding() => $_ensure(10);

  @$pb.TagNumber(12)
  RestPattern get rest => $_getN(11);
  @$pb.TagNumber(12)
  set rest(RestPattern value) => $_setField(12, value);
  @$pb.TagNumber(12)
  $core.bool hasRest() => $_has(11);
  @$pb.TagNumber(12)
  void clearRest() => $_clearField(12);
  @$pb.TagNumber(12)
  RestPattern ensureRest() => $_ensure(11);

  /// Guard expression evaluated after structural match succeeds.
  /// Universal: Dart 'when', Rust 'if', Python 'if', C# 'when', Scala 'if'.
  @$pb.TagNumber(15)
  Expression get guard => $_getN(12);
  @$pb.TagNumber(15)
  set guard(Expression value) => $_setField(15, value);
  @$pb.TagNumber(15)
  $core.bool hasGuard() => $_has(12);
  @$pb.TagNumber(15)
  void clearGuard() => $_clearField(15);
  @$pb.TagNumber(15)
  Expression ensureGuard() => $_ensure(12);

  /// Cosmetic metadata (source location, original syntax form).
  @$pb.TagNumber(16)
  $0.Struct get metadata => $_getN(13);
  @$pb.TagNumber(16)
  set metadata($0.Struct value) => $_setField(16, value);
  @$pb.TagNumber(16)
  $core.bool hasMetadata() => $_has(13);
  @$pb.TagNumber(16)
  void clearMetadata() => $_clearField(16);
  @$pb.TagNumber(16)
  $0.Struct ensureMetadata() => $_ensure(13);
}

/// Matches any value, binds nothing. The universal wildcard.
class WildcardPattern extends $pb.GeneratedMessage {
  factory WildcardPattern() => create();

  WildcardPattern._();

  factory WildcardPattern.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory WildcardPattern.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'WildcardPattern',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ball.v1'),
      createEmptyInstance: create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  WildcardPattern clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  WildcardPattern copyWith(void Function(WildcardPattern) updates) =>
      super.copyWith((message) => updates(message as WildcardPattern))
          as WildcardPattern;
  ...
  @$core.pragma('dart2js:noInline')
  static WildcardPattern create() => WildcardPattern._();
  @$core.override
  WildcardPattern createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static WildcardPattern getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<WildcardPattern>(create);
  static WildcardPattern? _defaultInstance;
}

/// Binds the matched value to a named variable, optionally with a type constraint.
class VariablePattern extends $pb.GeneratedMessage {
  factory VariablePattern({
    $core.String? name,
    TypeRef? type,
    $core.bool? isFinal,
  }) {
  ...
  factory VariablePattern.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory VariablePattern.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'VariablePattern',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ball.v1'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<TypeRef>(2, _omitFieldNames ? '' : 'type', subBuilder: TypeRef.create)
    ..aOB(3, _omitFieldNames ? '' : 'isFinal')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  VariablePattern clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  VariablePattern copyWith(void Function(VariablePattern) updates) =>
      super.copyWith((message) => updates(message as VariablePattern))
          as VariablePattern;
  ...
  @$core.pragma('dart2js:noInline')
  static VariablePattern create() => VariablePattern._();
  @$core.override
  VariablePattern createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static VariablePattern getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<VariablePattern>(create);
  static VariablePattern? _defaultInstance;
  ...
  @$pb.TagNumber(2)
  TypeRef get type => $_getN(1);
  @$pb.TagNumber(2)
  set type(TypeRef value) => $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasType() => $_has(1);
  @$pb.TagNumber(2)
  void clearType() => $_clearField(2);
  @$pb.TagNumber(2)
  TypeRef ensureType() => $_ensure(1);
...
class ConstantPattern extends $pb.GeneratedMessage {
  factory ConstantPattern({
    Expression? value,
  }) {
    final result = create();
    if (value != null) result.value = value;
  ...
  factory ConstantPattern.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ConstantPattern.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ConstantPattern',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ball.v1'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ConstantPattern clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ConstantPattern copyWith(void Function(ConstantPattern) updates) =>
      super.copyWith((message) => updates(message as ConstantPattern))
          as ConstantPattern;
  ...
  @$core.pragma('dart2js:noInline')
  static ConstantPattern create() => ConstantPattern._();
  @$core.override
  ConstantPattern createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static ConstantPattern getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ConstantPattern>(create);
  static ConstantPattern? _defaultInstance;
...
class TypeTestPattern extends $pb.GeneratedMessage {
  factory TypeTestPattern({
    TypeRef? type,
    Pattern? inner,
    $core.bool? isCast,
    $core.bool? isNullCheck,
    $core.bool? isNullAssert,
  }) {
    final result = create();
    if (type != null) result.type = type;
    if (inner != null) result.inner = inner;
    if (isCast != null) result.isCast = isCast;
    if (isNullCheck != null) result.isNullCheck = isNullCheck;
    if (isNullAssert != null) result.isNullAssert = isNullAssert;
    return result;
  }

  TypeTestPattern._();

  factory TypeTestPattern.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory TypeTestPattern.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TypeTestPattern',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ball.v1'),
      createEmptyInstance: create)
    ..aOM<TypeRef>(1, _omitFieldNames ? '' : 'type', subBuilder: TypeRef.create)
    ..aOM<Pattern>(2, _omitFieldNames ? '' : 'inner',
        subBuilder: Pattern.create)
    ..aOB(3, _omitFieldNames ? '' : 'isCast')
    ..aOB(4, _omitFieldNames ? '' : 'isNullCheck')
    ..aOB(5, _omitFieldNames ? '' : 'isNullAssert')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  TypeTestPattern clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  TypeTestPattern copyWith(void Function(TypeTestPattern) updates) =>
      super.copyWith((message) => updates(message as TypeTestPattern))
          as TypeTestPattern;
  ...
  @$core.pragma('dart2js:noInline')
  static TypeTestPattern create() => TypeTestPattern._();
  @$core.override
  TypeTestPattern createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static TypeTestPattern getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TypeTestPattern>(create);
  static TypeTestPattern? _defaultInstance;
  ...
  @$pb.TagNumber(2)
  Pattern get inner => $_getN(1);
  @$pb.TagNumber(2)
  set inner(Pattern value) => $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasInner() => $_has(1);
  @$pb.TagNumber(2)
  void clearInner() => $_clearField(2);
  @$pb.TagNumber(2)
  Pattern ensureInner() => $_ensure(1);

  @$pb.TagNumber(3)
  $core.bool get isCast => $_getBF(2);
  @$pb.TagNumber(3)
  set isCast($core.bool value) => $_setBool(2, value);
  @$pb.TagNumber(3)
  $core.bool hasIsCast() => $_has(2);
  @$pb.TagNumber(3)
  void clearIsCast() => $_clearField(3);

  @$pb.TagNumber(4)
  $core.bool get isNullCheck => $_getBF(3);
  @$pb.TagNumber(4)
  set isNullCheck($core.bool value) => $_setBool(3, value);
  @$pb.TagNumber(4)
  $core.bool hasIsNullCheck() => $_has(3);
  @$pb.TagNumber(4)
  void clearIsNullCheck() => $_clearField(4);

  @$pb.TagNumber(5)
  $core.bool get isNullAssert => $_getBF(4);
  @$pb.TagNumber(5)
  set isNullAssert($core.bool value) => $_setBool(4, value);
  @$pb.TagNumber(5)
  $core.bool hasIsNullAssert() => $_has(4);
  @$pb.TagNumber(5)
  void clearIsNullAssert() => $_clearField(5);
}

/// Destructures by position and/or name (tuples, records, constructors).
class DestructurePattern extends $pb.GeneratedMessage {
  factory DestructurePattern({
    TypeRef? type,
    $core.Iterable<DestructureField>? fields,
  }) {
    final result = create();
    if (type != null) result.type = type;
    if (fields != null) result.fields.addAll(fields);
  ...
  DestructurePattern._();

  factory DestructurePattern.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory DestructurePattern.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'DestructurePattern',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ball.v1'),
      createEmptyInstance: create)
    ..aOM<TypeRef>(1, _omitFieldNames ? '' : 'type', subBuilder: TypeRef.create)
    ..pPM<DestructureField>(2, _omitFieldNames ? '' : 'fields',
        subBuilder: DestructureField.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  DestructurePattern clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  DestructurePattern copyWith(void Function(DestructurePattern) updates) =>
      super.copyWith((message) => updates(message as DestructurePattern))
          as DestructurePattern;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static DestructurePattern create() => DestructurePattern._();
  @$core.override
  DestructurePattern createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static DestructurePattern getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DestructurePattern>(create);
  static DestructurePattern? _defaultInstance;
  ...
  @$pb.TagNumber(2)
  $pb.PbList<DestructureField> get fields => $_getList(1);
}

class DestructureField extends $pb.GeneratedMessage {
  factory DestructureField({
    $core.String? name,
    Pattern? pattern,
  }) {
    final result = create();
  ...
  factory DestructureField.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory DestructureField.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'DestructureField',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ball.v1'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<Pattern>(2, _omitFieldNames ? '' : 'pattern',
        subBuilder: Pattern.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  DestructureField clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  DestructureField copyWith(void Function(DestructureField) updates) =>
      super.copyWith((message) => updates(message as DestructureField))
          as DestructureField;
  ...
  @$core.pragma('dart2js:noInline')
  static DestructureField create() => DestructureField._();
  @$core.override
  DestructureField createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static DestructureField getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DestructureField>(create);
  static DestructureField? _defaultInstance;
  ...
  @$pb.TagNumber(2)
  Pattern get pattern => $_getN(1);
  @$pb.TagNumber(2)
  set pattern(Pattern value) => $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasPattern() => $_has(1);
  @$pb.TagNumber(2)
  void clearPattern() => $_clearField(2);
  @$pb.TagNumber(2)
  Pattern ensurePattern() => $_ensure(1);
}

/// Matches a sequence (list/array/slice) element by element.
class ListPattern extends $pb.GeneratedMessage {
  factory ListPattern({
    $core.Iterable<Pattern>? elements,
  }) {
    final result = create();
    if (elements != null) result.elements.addAll(elements);
    return result;
  ...
  factory ListPattern.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ListPattern.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ListPattern',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ball.v1'),
      createEmptyInstance: create)
    ..pPM<Pattern>(1, _omitFieldNames ? '' : 'elements',
        subBuilder: Pattern.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListPattern clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListPattern copyWith(void Function(ListPattern) updates) =>
      super.copyWith((message) => updates(message as ListPattern))
          as ListPattern;
  ...
  @$core.pragma('dart2js:noInline')
  static ListPattern create() => ListPattern._();
  @$core.override
  ListPattern createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static ListPattern getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ListPattern>(create);
  static ListPattern? _defaultInstance;

  @$pb.TagNumber(1)
  $pb.PbList<Pattern> get elements => $_getList(0);
}

/// Matches a mapping (dictionary/map) by key-value pairs.
class MapPattern extends $pb.GeneratedMessage {
  factory MapPattern({
    $core.Iterable<MapPatternEntry>? entries,
    Pattern? rest,
  }) {
    final result = create();
  ...
  factory MapPattern.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory MapPattern.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'MapPattern',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ball.v1'),
      createEmptyInstance: create)
    ..pPM<MapPatternEntry>(1, _omitFieldNames ? '' : 'entries',
        subBuilder: MapPatternEntry.create)
    ..aOM<Pattern>(2, _omitFieldNames ? '' : 'rest', subBuilder: Pattern.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  MapPattern clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  MapPattern copyWith(void Function(MapPattern) updates) =>
      super.copyWith((message) => updates(message as MapPattern)) as MapPattern;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static MapPattern create() => MapPattern._();
  @$core.override
  MapPattern createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static MapPattern getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<MapPattern>(create);
  static MapPattern? _defaultInstance;

  @$pb.TagNumber(1)
  $pb.PbList<MapPatternEntry> get entries => $_getList(0);

  @$pb.TagNumber(2)
  Pattern get rest => $_getN(1);
  @$pb.TagNumber(2)
  set rest(Pattern value) => $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasRest() => $_has(1);
  @$pb.TagNumber(2)
  void clearRest() => $_clearField(2);
  @$pb.TagNumber(2)
  Pattern ensureRest() => $_ensure(1);
}

class MapPatternEntry extends $pb.GeneratedMessage {
  factory MapPatternEntry({
    Expression? key,
    Pattern? valuePattern,
  }) {
    final result = create();
    if (key != null) result.key = key;
    if (valuePattern != null) result.valuePattern = valuePattern;
    return result;
  }

  MapPatternEntry._();

  factory MapPatternEntry.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory MapPatternEntry.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'MapPatternEntry',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ball.v1'),
      createEmptyInstance: create)
    ..aOM<Expression>(1, _omitFieldNames ? '' : 'key',
        subBuilder: Expression.create)
    ..aOM<Pattern>(2, _omitFieldNames ? '' : 'valuePattern',
        subBuilder: Pattern.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  MapPatternEntry clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  MapPatternEntry copyWith(void Function(MapPatternEntry) updates) =>
      super.copyWith((message) => updates(message as MapPatternEntry))
          as MapPatternEntry;
  ...
  @$core.pragma('dart2js:noInline')
  static MapPatternEntry create() => MapPatternEntry._();
  @$core.override
  MapPatternEntry createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static MapPatternEntry getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<MapPatternEntry>(create);
  static MapPatternEntry? _defaultInstance;

  @$pb.TagNumber(1)
  Expression get key => $_getN(0);
  @$pb.TagNumber(1)
  set key(Expression value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasKey() => $_has(0);
  @$pb.TagNumber(1)
  void clearKey() => $_clearField(1);
  @$pb.TagNumber(1)
  Expression ensureKey() => $_ensure(0);

  @$pb.TagNumber(2)
  Pattern get valuePattern => $_getN(1);
  @$pb.TagNumber(2)
  set valuePattern(Pattern value) => $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasValuePattern() => $_has(1);
  @$pb.TagNumber(2)
  void clearValuePattern() => $_clearField(2);
  @$pb.TagNumber(2)
  Pattern ensureValuePattern() => $_ensure(1);
}

/// Matches if any sub-pattern matches (disjunction).
class OrPattern extends $pb.GeneratedMessage {
  factory OrPattern({
  ...
  factory OrPattern.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory OrPattern.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'OrPattern',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ball.v1'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  OrPattern clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  OrPattern copyWith(void Function(OrPattern) updates) =>
      super.copyWith((message) => updates(message as OrPattern)) as OrPattern;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static OrPattern create() => OrPattern._();
  @$core.override
  OrPattern createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static OrPattern getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<OrPattern>(create);
  static OrPattern? _defaultInstance;
...
class AndPattern extends $pb.GeneratedMessage {
  factory AndPattern({
    $core.Iterable<Pattern>? patterns,
  }) {
    final result = create();
  ...
  factory AndPattern.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AndPattern.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AndPattern',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ball.v1'),
      createEmptyInstance: create)
    ..pPM<Pattern>(1, _omitFieldNames ? '' : 'patterns',
        subBuilder: Pattern.create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AndPattern clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AndPattern copyWith(void Function(AndPattern) updates) =>
      super.copyWith((message) => updates(message as AndPattern)) as AndPattern;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AndPattern create() => AndPattern._();
  @$core.override
  AndPattern createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static AndPattern getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AndPattern>(create);
  static AndPattern? _defaultInstance;
...
class RelationalPattern extends $pb.GeneratedMessage {
  factory RelationalPattern({
  ...
  factory RelationalPattern.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory RelationalPattern.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RelationalPattern',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ball.v1'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'operator')
    ..aOM<Expression>(2, _omitFieldNames ? '' : 'operand',
        subBuilder: Expression.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RelationalPattern clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RelationalPattern copyWith(void Function(RelationalPattern) updates) =>
      super.copyWith((message) => updates(message as RelationalPattern))
          as RelationalPattern;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static RelationalPattern create() => RelationalPattern._();
  @$core.override
  RelationalPattern createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static RelationalPattern getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RelationalPattern>(create);
  static RelationalPattern? _defaultInstance;
  ...
  @$pb.TagNumber(2)
  Expression get operand => $_getN(1);
  @$pb.TagNumber(2)
  set operand(Expression value) => $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasOperand() => $_has(1);
  @$pb.TagNumber(2)
  void clearOperand() => $_clearField(2);
  @$pb.TagNumber(2)
  Expression ensureOperand() => $_ensure(1);
}

/// Matches the inner pattern and binds the entire value to a name.
class BindingPattern extends $pb.GeneratedMessage {
  factory BindingPattern({
    $core.String? name,
    Pattern? pattern,
  }) {
    final result = create();
  ...
  factory BindingPattern.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory BindingPattern.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BindingPattern',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ball.v1'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<Pattern>(2, _omitFieldNames ? '' : 'pattern',
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  BindingPattern clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  BindingPattern copyWith(void Function(BindingPattern) updates) =>
      super.copyWith((message) => updates(message as BindingPattern))
          as BindingPattern;
  ...
  @$core.pragma('dart2js:noInline')
  static BindingPattern create() => BindingPattern._();
  @$core.override
  BindingPattern createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static BindingPattern getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BindingPattern>(create);
  static BindingPattern? _defaultInstance;
...
class RestPattern extends $pb.GeneratedMessage {
  factory RestPattern({
    Pattern? pattern,
  }) {
    final result = create();
  ...
  factory RestPattern.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory RestPattern.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RestPattern',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ball.v1'),
      createEmptyInstance: create)
    ..aOM<Pattern>(1, _omitFieldNames ? '' : 'pattern',
        subBuilder: Pattern.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RestPattern clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RestPattern copyWith(void Function(RestPattern) updates) =>
      super.copyWith((message) => updates(message as RestPattern))
          as RestPattern;
  ...
  @$core.pragma('dart2js:noInline')
  static RestPattern create() => RestPattern._();
  @$core.override
  RestPattern createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static RestPattern getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RestPattern>(create);
  static RestPattern? _defaultInstance;

  @$pb.TagNumber(1)
  Pattern get pattern => $_getN(0);
  @$pb.TagNumber(1)
  set pattern(Pattern value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasPattern() => $_has(0);
  @$pb.TagNumber(1)
  void clearPattern() => $_clearField(1);
  @$pb.TagNumber(1)
  Pattern ensurePattern() => $_ensure(0);
}
