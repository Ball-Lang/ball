...
export function _analyzeTerminationCore(ctx: any): any {
  ...
  let baseModules = _identifyBaseModules(modules);
  let warnings = [];
  let callGraph = _buildCallGraph({ ['modules']: modules, ['baseModules']: baseModules, ['customBaseFns']: _collectCustomBaseFns(modules), ['userFns']: _collectUserFunctionNames(modules) });
