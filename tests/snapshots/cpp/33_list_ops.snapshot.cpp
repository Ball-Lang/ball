...
int main() {
    auto nums = BallDyn(std::vector<int64_t>{3LL, 1LL, 4LL, 1LL, 5LL});
    std::cout << ball_to_string(ball_to_string(ball_length(nums))) << std::endl;
    std::cout << ball_to_string(ball_to_string(static_cast<BallDyn>(nums)[2LL])) << std::endl;
    auto sum = BallDyn(0LL);
    for (auto i = 0LL; (i < ball_length(nums)); ball_assign(i, (i + 1LL))) {
