...
int main() {
    auto a = BallDyn(240LL);
    auto b = BallDyn(15LL);
    std::cout << ball_to_string(ball_to_string((a & b))) << std::endl;
    std::cout << ball_to_string(ball_to_string((a | b))) << std::endl;
    std::cout << ball_to_string(ball_to_string((a ^ b))) << std::endl;
    std::cout << ball_to_string(ball_to_string((a >> 4LL))) << std::endl;
    std::cout << ball_to_string(ball_to_string((b << 4LL))) << std::endl;
    std::cout << ball_to_string(ball_to_string((~0LL))) << std::endl;
    return 0;
}
