...
| `assign` | ✅ | ✅ 118 fixture(s): `100_complex_control_flow`, `101_simple_class`, `104_getter_setter` +115 more | ✅ |
...
| `print` | ✅ | ✅ 330 fixture(s): `100_complex_control_flow`, `101_simple_class`, `102_inheritance` +327 more | ✅ |
| `regex_find` | ❌ | ❌ | ✅ |
| `regex_find_all` | ❌ | ❌ | ✅ |
| `regex_match` | ❌ | ❌ | ✅ |
| `regex_replace` | ❌ | ❌ | ✅ |
